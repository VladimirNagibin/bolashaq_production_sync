...
class Productsection(CommonFieldMixin):
    """
    ...
    code: str | None = Field(None, alias="CODE")  # Символьный код
    xml_id: str | None = Field(None, alias="XML_ID")  # Внешний код
    catalog_id: int | None = Field(None, alias="CATALOG_ID")  # Каталог
    section_id: int | None = Field(None, alias="SECTION_ID")  # Раздел
...
class ProductsectionUpdate(CommonFieldMixin):
    """
    Общие поля создания и обновления с алиасами для соответствия
    SQLAlchemy модели
    """
